...
function PaymentChart({ data, todayExpense }) {
  ...
  const downloadChart = async () => {
    ...
    try {
      ...
      link.download =
        `SmartBilling_PaymentSummary_${new Date()
  ...
  return (
        ...
        >
          ...
          <div
            className="
              ...
              backdrop-blur-md
              rounded-full
              shadow-[inset_0_2px_4px_rgba(255,255,255,0.9),0_4px_12px_rgba(0,0,0,0.02)]
              flex
              flex-col
              items-center
              justify-center
    ...
    "
      ...
      "
            >
              ₹{Number(todayExpense).toLocaleString("en-IN")}
            </span>
